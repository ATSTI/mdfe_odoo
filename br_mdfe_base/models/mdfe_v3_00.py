...
#
# Generated Thu Oct 10 17:37:03 2019 by generateDS.py version 2.33.11.
# Python 3.7.3 (v3.7.3:ef4ec6ed12, Mar 25 2019, 22:22:05) [MSC v.1916 64 bit (AMD64)]
#
# Command line options:
#   ('-f', '')
#   ('-o', 'mdfe_odoo/br_mdfe_base/models/mdfe_v3_00.py')
#
# Command line arguments:
#   Generate/schemas/mdfe_v3.00.xsd
#
# Command line:
#   D:\desenvolvimentos\Modulos-do-odoo\venv\Scripts\generateDS -f -o "mdfe_odoo/br_mdfe_base/models/mdfe_v3_00.py" Generate/schemas/mdfe_v3.00.xsd
#
...
class indCanalVerdeType(Enum):
    """Indicador de participação do Canal Verde"""
    _1='1'


class indCarregaPosteriorType(Enum):
    """Indicador de MDF-e com inclusão da Carga posterior a emissão por evento
    de inclusão de DF-e"""
    _1='1'


class indReentregaType(Enum):
    """Indicador de Reentrega"""
    _1='1'


class indReentregaType1(Enum):
    """Indicador de Reentrega"""
    _1='1'


class indReentregaType9(Enum):
    """Indicador de Reentrega"""
    _1='1'


class respSegType(Enum):
...
class TMDFe(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, infMDFe=None, infMDFeSupl=None, Signature=None, gds_collector_=None, **kwargs_):
        ...
        self.infMDFeSupl = infMDFeSupl
        self.infMDFeSupl_nsprefix_ = None
    ...
    def set_infMDFe(self, infMDFe):
        self.infMDFe = infMDFe
    def get_infMDFeSupl(self):
        return self.infMDFeSupl
    def set_infMDFeSupl(self, infMDFeSupl):
        self.infMDFeSupl = infMDFeSupl
    ...
    def hasContent_(self):
        if (
            ...
            self.infMDFeSupl is not None or
            self.Signature is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns="http://www.portalfiscal.inf.br/mdfe"', name_='TMDFe', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TMDFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TMDFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TMDFe'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns="http://www.portalfiscal.inf.br/mdfe"', name_='TMDFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infMDFeSupl is not None:
            namespaceprefix_ = self.infMDFeSupl_nsprefix_ + ':' if (UseCapturedNS_ and self.infMDFeSupl_nsprefix_) else ''
            self.infMDFeSupl.export(outfile, level, namespaceprefix_, namespacedef_='', name_='infMDFeSupl', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'infMDFeSupl':
            obj_ = infMDFeSuplType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.infMDFeSupl = obj_
            obj_.original_tagname_ = 'infMDFeSupl'
...
class TEnviMDFe(GeneratedsSuper):
    ...
    def validate_TIdLote(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                self.gds_collector_.add_message('Value (%(value)s) is not of the correct base simple type (str)' % {"value": value, })
                return False
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEnviMDFe', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TEnviMDFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TEnviMDFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TEnviMDFe'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEnviMDFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TRetMDFe(GeneratedsSuper):
    """Tipo Retorno do Pedido de Autorização do MDF-e"""
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, versao=None, tpAmb=None, cUF=None, verAplic=None, cStat=None, xMotivo=None, protMDFe=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TRetMDFe)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TRetMDFe.subclass:
            return TRetMDFe.subclass(*args_, **kwargs_)
        else:
            return TRetMDFe(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def validate_TCodUfIBGE(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on TCodUfIBGE' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_TVerAplic(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on TVerAplic' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on TVerAplic' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_TMotivo(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 255:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on TMotivo' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on TMotivo' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TRetMDFe', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TRetMDFe')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TRetMDFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TRetMDFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TRetMDFe'):
        if 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.versao), input_name='versao')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TRetMDFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpAmb(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='tpAmb', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='tpAmb')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tpAmb', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='tpAmb'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='tpAmb', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        already_processed = set()
...
class TRetEnviMDFe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TRetEnviMDFe', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TRetEnviMDFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TRetEnviMDFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TRetEnviMDFe'):
        if 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.versao), input_name='versao')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TRetEnviMDFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TEndeEmi(GeneratedsSuper):
    ...
    def validate_xLgrType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xLgrType' % {"value" : value} )
                result = False
            if len(value) < 2:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xLgrType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_nroType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nroType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nroType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xCplType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xCplType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xCplType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xBairroType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xBairroType' % {"value" : value} )
                result = False
            if len(value) < 2:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xBairroType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xMunType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xMunType' % {"value" : value} )
                result = False
            if len(value) < 2:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xMunType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_TUf(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on TUf' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    ...
    def validate_TEmail(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on TEmail' % {"value" : encode_str_2_3(value)} )
                result = False
            if len(value) < 6:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on TEmail' % {"value" : encode_str_2_3(value)} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEndeEmi', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TEndeEmi')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TEndeEmi', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TEndeEmi'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEndeEmi', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TEndereco(GeneratedsSuper):
    ...
    def validate_xLgrType17(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 255:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xLgrType17' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xLgrType17' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_nroType18(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nroType18' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nroType18' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xCplType19(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xCplType19' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xCplType19' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xBairroType20(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xBairroType20' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xBairroType20' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xMunType21(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xMunType21' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xMunType21' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xPaisType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xPaisType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xPaisType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TEndereco'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEndereco', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TEndernac(GeneratedsSuper):
    ...
    def validate_xLgrType23(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 255:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xLgrType23' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xLgrType23' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_nroType24(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nroType24' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nroType24' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xCplType25(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xCplType25' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xCplType25' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xBairroType26(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xBairroType26' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xBairroType26' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xMunType27(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xMunType27' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xMunType27' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEndernac', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TEndernac')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TEndernac', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TEndernac'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEndernac', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TEnderFer(GeneratedsSuper):
    ...
    def validate_xLgrType29(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 255:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xLgrType29' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xLgrType29' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_nroType30(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nroType30' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nroType30' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xCplType31(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xCplType31' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xCplType31' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xBairroType32(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xBairroType32' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xBairroType32' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xMunType33(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xMunType33' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xMunType33' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEnderFer', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TEnderFer')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TEnderFer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TEnderFer'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEnderFer', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TEndOrg(GeneratedsSuper):
    ...
    def validate_xLgrType35(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xLgrType35' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xLgrType35' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_nroType36(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nroType36' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nroType36' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xCplType37(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xCplType37' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xCplType37' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xBairroType38(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xBairroType38' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xBairroType38' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xMunType39(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xMunType39' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xMunType39' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xPaisType42(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xPaisType42' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xPaisType42' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEndOrg', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TEndOrg')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TEndOrg', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TEndOrg'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEndOrg', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TLocal(GeneratedsSuper):
    ...
    def validate_xMunType44(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xMunType44' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xMunType44' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TLocal'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TLocal', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TEndReEnt(GeneratedsSuper):
    ...
    def validate_xNomeType45(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xNomeType45' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xNomeType45' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xLgrType46(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 255:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xLgrType46' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xLgrType46' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_nroType47(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nroType47' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nroType47' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xCplType48(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xCplType48' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xCplType48' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xBairroType49(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xBairroType49' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xBairroType49' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xMunType50(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xMunType50' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xMunType50' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEndReEnt', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TEndReEnt')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TEndReEnt', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TEndReEnt'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TEndReEnt', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TNFeNF(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TNFeNF', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TNFeNF')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TNFeNF', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TNFeNF'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TNFeNF', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TUnidadeTransp(GeneratedsSuper):
    ...
    def validate_TtipoUnidTransp(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on TtipoUnidTransp' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_TContainer(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on TContainer' % {"value" : encode_str_2_3(value)} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on TContainer' % {"value" : encode_str_2_3(value)} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TUnidadeTransp', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TUnidadeTransp')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TUnidadeTransp', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TUnidadeTransp'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TUnidadeTransp', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TUnidCarga(GeneratedsSuper):
    ...
    def validate_TtipoUnidCarga(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on TtipoUnidCarga' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_TContainer(self, value):
        result = True
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TUnidCarga', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TUnidCarga')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TUnidCarga', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TUnidCarga'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TUnidCarga', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TRespTec(GeneratedsSuper):
    ...
    def __init__(self, CNPJ=None, xContato=None, email=None, fone=None, idCSRT=None, hashCSRT=None, gds_collector_=None, **kwargs_):
        ...
        self.email_nsprefix_ = None
        self.fone = fone
        self.validate_foneType56(self.fone)
        self.fone_nsprefix_ = None
        self.idCSRT = idCSRT
    ...
    def validate_xContatoType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xContatoType' % {"value" : value} )
                result = False
            if len(value) < 2:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xContatoType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_TEmail(self, value):
        ...
        return result
    validate_TEmail_patterns_ = [['^([^@]+@[^\\.]+\\..+)$']]
    def validate_foneType56(self, value):
        result = True
        # Validate type foneType56, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                self.gds_collector_.add_message('Value (%(value)s) is not of the correct base simple type (str)' % {"value": value, })
                return False
            if not self.gds_validate_simple_patterns(
                    self.validate_foneType56_patterns_, value):
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_foneType56_patterns_, ))
                result = False
        return result
    validate_foneType56_patterns_ = [['^([0-9]{7,12})$']]
    ...
    def validate_hashCSRTType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if len(value) != 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd length restriction on hashCSRTType' % {"value" : value} )
                result = False
        return result
    def hasContent_(self):
        if (
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TRespTec', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TRespTec')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TRespTec', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TRespTec'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TRespTec', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TProtMDFe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns="http://www.w3.org/2001/XMLSchema" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns="http://www.portalfiscal.inf.br/mdfe"', name_='TProtMDFe', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TProtMDFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TProtMDFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TProtMDFe'):
        if 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.versao), input_name='versao')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns="http://www.w3.org/2001/XMLSchema" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns="http://www.portalfiscal.inf.br/mdfe"', name_='TProtMDFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SignedInfoType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='ds:', namespacedef_='xmlns="http://www.w3.org/2001/XMLSchema" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns="http://www.portalfiscal.inf.br/mdfe"', name_='SignedInfoType', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='ds:', name_='SignedInfoType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (quote_attrib(self.Id), ))
    def exportChildren(self, outfile, level, namespaceprefix_='ds:', namespacedef_='xmlns="http://www.w3.org/2001/XMLSchema" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns="http://www.portalfiscal.inf.br/mdfe"', name_='SignedInfoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TransformType(GeneratedsSuper):
    ...
    def validate_TTransformURI(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on TTransformURI' % {"value" : encode_str_2_3(value)} )
                result = False
    def hasContent_(self):
        if (
            self.XPath
...
class infMDFeType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, versao=None, Id=None, ide=None, emit=None, infModal=None, infDoc=None, seg=None, tot=None, lacres=None, autXML=None, infAdic=None, infRespTec=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infMDFeType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infMDFeType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infMDFeType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infMDFeType'):
        if 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.versao), input_name='versao')), ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infMDFeType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ideType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, cUF=None, tpAmb=None, tpEmit=None, tpTransp=None, mod=None, serie=None, nMDF=None, cMDF=None, cDV=None, modal=None, dhEmi=None, tpEmis=None, procEmi=None, verProc=None, UFIni=None, UFFim=None, infMunCarrega=None, infPercurso=None, dhIniViagem=None, indCanalVerde=None, indCarregaPosterior=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        ...
        self.indCarregaPosterior = indCarregaPosterior
        self.validate_indCarregaPosteriorType(self.indCarregaPosterior)
        self.indCarregaPosterior_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_indCanalVerde(self, indCanalVerde):
        self.indCanalVerde = indCanalVerde
    def get_indCarregaPosterior(self):
        return self.indCarregaPosterior
    def set_indCarregaPosterior(self, indCarregaPosterior):
        self.indCarregaPosterior = indCarregaPosterior
    def validate_TCodUfIBGE(self, value):
        result = True
        # Validate type TCodUfIBGE, a restriction on xs:string.
    ...
    def validate_TAmb(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['1', '2']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on TAmb' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_TEmit(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['1', '2', '3']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on TEmit' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_TTransp(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['1', '2', '3']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on TTransp' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_TModMD(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['58']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on TModMD' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    ...
    def validate_TModalMD(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['1', '2', '3', '4']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on TModalMD' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    ...
    def validate_tpEmisType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['1', '2']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on tpEmisType' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_procEmiType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['0']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on procEmiType' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_verProcType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on verProcType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on verProcType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_indCanalVerdeType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['1']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on indCanalVerdeType' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_indCarregaPosteriorType(self, value):
        result = True
        # Validate type indCarregaPosteriorType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                self.gds_collector_.add_message('Value (%(value)s) is not of the correct base simple type (str)' % {"value": value, })
                return False
            ...
            enumerations = ['1']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on indCarregaPosteriorType' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def hasContent_(self):
        if (
            ...
            self.indCanalVerde is not None or
            self.indCarregaPosterior is not None
        ):
            return True
        else:
            return False
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='ideType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.indCarregaPosterior is not None:
            namespaceprefix_ = self.indCarregaPosterior_nsprefix_ + ':' if (UseCapturedNS_ and self.indCarregaPosterior_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sindCarregaPosterior>%s</%sindCarregaPosterior>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.indCarregaPosterior), input_name='indCarregaPosterior')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        already_processed = set()
        self.ns_prefix_ = node.prefix
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'cUF':
            ...
            self.validate_indCanalVerdeType(self.indCanalVerde)
        elif nodeName_ == 'indCarregaPosterior':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'indCarregaPosterior')
            value_ = self.gds_validate_string(value_, node, 'indCarregaPosterior')
            self.indCarregaPosterior = value_
            self.indCarregaPosterior_nsprefix_ = child_.prefix
            # validate type indCarregaPosteriorType
            self.validate_indCarregaPosteriorType(self.indCarregaPosterior)
# end class ideType
...
class infMunCarregaType(GeneratedsSuper):
    ...
    def validate_xMunCarregaType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xMunCarregaType' % {"value" : value} )
                result = False
            if len(value) < 2:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xMunCarregaType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infMunCarregaType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infMunCarregaType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infMunCarregaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infMunCarregaType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infMunCarregaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infPercursoType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infPercursoType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infPercursoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infPercursoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infPercursoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infPercursoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class emitType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, CNPJ=None, CPF=None, IE=None, xNome=None, xFant=None, enderEmit=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
    ...
    def validate_xNomeType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xNomeType' % {"value" : value} )
                result = False
            if len(value) < 2:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xNomeType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xFantType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xFantType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xFantType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='emitType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='emitType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infModalType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infModalType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infModalType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infModalType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infModalType'):
        if 'versaoModal' not in already_processed:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infModalType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infDocType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infDocType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infDocType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infDocType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infDocType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infDocType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infMunDescargaType(GeneratedsSuper):
    ...
    def validate_xMunDescargaType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xMunDescargaType' % {"value" : value} )
                result = False
            if len(value) < 2:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xMunDescargaType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infMunDescargaType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infMunDescargaType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infMunDescargaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infMunDescargaType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infMunDescargaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infCTeType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, chCTe=None, SegCodBarra=None, indReentrega=None, infUnidTransp=None, peri=None, infEntregaParcial=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        ...
        self.infEntregaParcial = infEntregaParcial
        self.infEntregaParcial_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_infEntregaParcial(self):
        return self.infEntregaParcial
    def set_infEntregaParcial(self, infEntregaParcial):
        self.infEntregaParcial = infEntregaParcial
    def validate_TChCTe(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 44:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on TChCTe' % {"value" : encode_str_2_3(value)} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_indReentregaType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['1']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on indReentregaType' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def hasContent_(self):
        if (
            ...
            self.peri or
            self.infEntregaParcial is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infCTeType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infCTeType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infCTeType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infCTeType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infCTeType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infEntregaParcial is not None:
            namespaceprefix_ = self.infEntregaParcial_nsprefix_ + ':' if (UseCapturedNS_ and self.infEntregaParcial_nsprefix_) else ''
            self.infEntregaParcial.export(outfile, level, namespaceprefix_, namespacedef_='', name_='infEntregaParcial', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        already_processed = set()
        self.ns_prefix_ = node.prefix
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'infEntregaParcial':
            obj_ = infEntregaParcialType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.infEntregaParcial = obj_
            obj_.original_tagname_ = 'infEntregaParcial'
...
class periType(GeneratedsSuper):
    ...
    def validate_xNomeAEType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 150:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xNomeAEType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xNomeAEType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xClaRiscoType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 40:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xClaRiscoType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xClaRiscoType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_grEmbType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 6:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on grEmbType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on grEmbType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_qTotProdType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on qTotProdType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on qTotProdType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_qVolTipoType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on qVolTipoType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on qVolTipoType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='periType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='periType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='periType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='periType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='periType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infEntregaParcialType(GeneratedsSuper):
    """Grupo de informações da Entrega Parcial (Corte de Voo)"""
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, qtdTotal=None, qtdParcial=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.qtdTotal = qtdTotal
        self.validate_TDec_1104(self.qtdTotal)
        self.qtdTotal_nsprefix_ = None
        self.qtdParcial = qtdParcial
        self.validate_TDec_1104(self.qtdParcial)
        self.qtdParcial_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infEntregaParcialType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infEntregaParcialType.subclass:
            return infEntregaParcialType.subclass(*args_, **kwargs_)
        else:
            return infEntregaParcialType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_qtdTotal(self):
        return self.qtdTotal
    def set_qtdTotal(self, qtdTotal):
        self.qtdTotal = qtdTotal
    def get_qtdParcial(self):
        return self.qtdParcial
    def set_qtdParcial(self, qtdParcial):
        self.qtdParcial = qtdParcial
    ...
    def hasContent_(self):
        if (
            self.qtdTotal is not None or
            self.qtdParcial is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infEntregaParcialType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infEntregaParcialType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infEntregaParcialType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infEntregaParcialType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infEntregaParcialType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infEntregaParcialType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.qtdTotal is not None:
            namespaceprefix_ = self.qtdTotal_nsprefix_ + ':' if (UseCapturedNS_ and self.qtdTotal_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sqtdTotal>%s</%sqtdTotal>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.qtdTotal), input_name='qtdTotal')), namespaceprefix_ , eol_))
        if self.qtdParcial is not None:
            namespaceprefix_ = self.qtdParcial_nsprefix_ + ':' if (UseCapturedNS_ and self.qtdParcial_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sqtdParcial>%s</%sqtdParcial>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.qtdParcial), input_name='qtdParcial')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        already_processed = set()
        self.ns_prefix_ = node.prefix
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'qtdTotal':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'qtdTotal')
            value_ = self.gds_validate_string(value_, node, 'qtdTotal')
            self.qtdTotal = value_
            self.qtdTotal_nsprefix_ = child_.prefix
            # validate type TDec_1104
            self.validate_TDec_1104(self.qtdTotal)
        elif nodeName_ == 'qtdParcial':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'qtdParcial')
            value_ = self.gds_validate_string(value_, node, 'qtdParcial')
            self.qtdParcial = value_
            self.qtdParcial_nsprefix_ = child_.prefix
            # validate type TDec_1104
            self.validate_TDec_1104(self.qtdParcial)
# end class infEntregaParcialType
...
class infNFeType(GeneratedsSuper):
    ...
    def validate_TChNFe(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 44:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on TChNFe' % {"value" : encode_str_2_3(value)} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_indReentregaType1(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['1']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on indReentregaType1' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def hasContent_(self):
        if (
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infNFeType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infNFeType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class periType2(GeneratedsSuper):
    ...
    def validate_xNomeAEType4(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 150:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xNomeAEType4' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xNomeAEType4' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xClaRiscoType5(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 40:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xClaRiscoType5' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xClaRiscoType5' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_grEmbType6(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 6:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on grEmbType6' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on grEmbType6' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_qTotProdType7(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on qTotProdType7' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on qTotProdType7' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_qVolTipoType8(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on qVolTipoType8' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on qVolTipoType8' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='periType2', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='periType2')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='periType2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='periType2'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='periType2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infMDFeTranspType(GeneratedsSuper):
    ...
    def validate_indReentregaType9(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['1']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on indReentregaType9' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infMDFeTranspType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infMDFeTranspType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infMDFeTranspType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infMDFeTranspType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infMDFeTranspType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class periType10(GeneratedsSuper):
    ...
    def validate_xNomeAEType12(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 150:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xNomeAEType12' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xNomeAEType12' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_xClaRiscoType13(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 40:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xClaRiscoType13' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xClaRiscoType13' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_grEmbType14(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 6:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on grEmbType14' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on grEmbType14' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_qTotProdType15(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on qTotProdType15' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on qTotProdType15' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_qVolTipoType16(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on qVolTipoType16' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on qVolTipoType16' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='periType10', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='periType10')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='periType10', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='periType10'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='periType10', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class segType(GeneratedsSuper):
    ...
    def validate_nApolType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nApolType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nApolType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_nAverType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 40:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nAverType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nAverType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='segType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='segType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='segType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='segType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='segType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infRespType(GeneratedsSuper):
    ...
    def validate_respSegType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['1', '2']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on respSegType' % {"value" : encode_str_2_3(value)} )
                result = False
            if len(value) > 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on respSegType' % {"value" : encode_str_2_3(value)} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on respSegType' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_TCnpj(self, value):
        result = True
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infRespType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infRespType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infRespType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infRespType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infRespType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infSegType(GeneratedsSuper):
    ...
    def validate_xSegType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 30:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xSegType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xSegType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infSegType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infSegType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infSegType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infSegType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infSegType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class totType(GeneratedsSuper):
    ...
    def validate_cUnidType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            enumerations = ['01', '02']
            if value not in enumerations:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd enumeration restriction on cUnidType' % {"value" : encode_str_2_3(value)} )
                result = False
        return result
    def validate_TDec_1104(self, value):
        result = True
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='totType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='totType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='totType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='totType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='totType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class lacresType(GeneratedsSuper):
    ...
    def validate_nLacreType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nLacreType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nLacreType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='lacresType', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='lacresType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='lacresType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class autXMLType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='autXMLType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='autXMLType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infAdicType(GeneratedsSuper):
    ...
    def validate_infAdFiscoType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 2000:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on infAdFiscoType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on infAdFiscoType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_infCplType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 5000:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on infCplType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on infCplType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infAdicType', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infAdicType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infAdicType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infMDFeSuplType(GeneratedsSuper):
    """Informações suplementares do MDF-e"""
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, qrCodMDFe=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.qrCodMDFe = qrCodMDFe
        self.validate_qrCodMDFeType(self.qrCodMDFe)
        self.qrCodMDFe_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infMDFeSuplType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infMDFeSuplType.subclass:
            return infMDFeSuplType.subclass(*args_, **kwargs_)
        else:
            return infMDFeSuplType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_qrCodMDFe(self):
        return self.qrCodMDFe
    def set_qrCodMDFe(self, qrCodMDFe):
        self.qrCodMDFe = qrCodMDFe
    def validate_qrCodMDFeType(self, value):
        result = True
        # Validate type qrCodMDFeType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                self.gds_collector_.add_message('Value (%(value)s) is not of the correct base simple type (str)' % {"value": value, })
                return False
            if len(value) > 1000:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on qrCodMDFeType' % {"value" : encode_str_2_3(value)} )
                result = False
            if len(value) < 50:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on qrCodMDFeType' % {"value" : encode_str_2_3(value)} )
                result = False
            if not self.gds_validate_simple_patterns(
                    self.validate_qrCodMDFeType_patterns_, value):
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_qrCodMDFeType_patterns_, ))
                result = False
        return result
    validate_qrCodMDFeType_patterns_ = [['^(((HTTPS?|https?)://.*\\?chMDFe=[0-9]{44}&tpAmb=[1-2](&sign=[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1})?))$']]
    def hasContent_(self):
        if (
            self.qrCodMDFe is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infMDFeSuplType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infMDFeSuplType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infMDFeSuplType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infMDFeSuplType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infMDFeSuplType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infMDFeSuplType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.qrCodMDFe is not None:
            namespaceprefix_ = self.qrCodMDFe_nsprefix_ + ':' if (UseCapturedNS_ and self.qrCodMDFe_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sqrCodMDFe>%s</%sqrCodMDFe>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.qrCodMDFe), input_name='qrCodMDFe')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        already_processed = set()
        self.ns_prefix_ = node.prefix
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'qrCodMDFe':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'qrCodMDFe')
            value_ = self.gds_validate_string(value_, node, 'qrCodMDFe')
            self.qrCodMDFe = value_
            self.qrCodMDFe_nsprefix_ = child_.prefix
            # validate type qrCodMDFeType
            self.validate_qrCodMDFeType(self.qrCodMDFe)
# end class infMDFeSuplType
...
class infRecType(GeneratedsSuper):
    ...
    def validate_tMedType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                self.gds_collector_.add_message('Value (%(value)s) is not of the correct base simple type (int)' % {"value": value, })
                return False
            if not self.gds_validate_simple_patterns(
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infRecType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infRecType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infNFeType51(GeneratedsSuper):
    ...
    def validate_TPIN(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 9:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on TPIN' % {"value" : encode_str_2_3(value)} )
                result = False
            if len(value) < 2:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on TPIN' % {"value" : encode_str_2_3(value)} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infNFeType51', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infNFeType51')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infNFeType51', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infNFeType51'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infNFeType51', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infNFType(GeneratedsSuper):
    ...
    def validate_serieType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 3:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on serieType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on serieType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def validate_nNFType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nNFType' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nNFType' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infNFType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infNFType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infNFType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infNFType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infNFType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class emiType(GeneratedsSuper):
    ...
    def validate_xNomeType52(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xNomeType52' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xNomeType52' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='emiType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='emiType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='emiType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='emiType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='emiType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class destType(GeneratedsSuper):
    ...
    def validate_xNomeType53(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 60:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on xNomeType53' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on xNomeType53' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='destType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='destType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class lacUnidTranspType(GeneratedsSuper):
    ...
    def validate_nLacreType54(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nLacreType54' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nLacreType54' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='lacUnidTranspType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='lacUnidTranspType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='lacUnidTranspType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='lacUnidTranspType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='lacUnidTranspType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class lacUnidCargaType(GeneratedsSuper):
    ...
    def validate_nLacreType55(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 20:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on nLacreType55' % {"value" : value} )
                result = False
            if len(value) < 1:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd minLength restriction on nLacreType55' % {"value" : value} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='lacUnidCargaType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='lacUnidCargaType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='lacUnidCargaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='lacUnidCargaType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='lacUnidCargaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infProtType(GeneratedsSuper):
    ...
    def validate_TChMDFe(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            if len(value) > 44:
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxLength restriction on TChMDFe' % {"value" : encode_str_2_3(value)} )
                result = False
            if not self.gds_validate_simple_patterns(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns="http://www.w3.org/2001/XMLSchema" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns="http://www.portalfiscal.inf.br/mdfe"', name_='infProtType', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infProtType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns="http://www.w3.org/2001/XMLSchema" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns="http://www.portalfiscal.inf.br/mdfe"', name_='infProtType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infFiscoType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infFiscoType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infFiscoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infFiscoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infFiscoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='infFiscoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from mdfe_v3_00 import *\n\n')
        sys.stdout.write('import mdfe_v3_00 as model_\n\n')
